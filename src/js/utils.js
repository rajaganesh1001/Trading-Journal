...
const Utils = (() => {
  ...
  const INDEX_META = {
    NIFTY50: { label: 'Nifty 50', short: 'NIFTY', color: '#1fb37a', glow: 'rgba(31,179,122,0.4)' },
    BANKNIFTY: { label: 'Bank Nifty', short: 'BANKNIFTY', color: '#3b82f6', glow: 'rgba(59,130,246,0.4)' },
    SENSEX: { label: 'Sensex', short: 'SENSEX', color: '#f0b429', glow: 'rgba(240,180,41,0.4)' },
    GENERAL: { label: 'General Market', short: 'GENERAL', color: '#14b8a6', glow: 'rgba(20,184,166,0.4)' }
  };
  ...
  return {
    ...
    downloadTextFile, toCSV, toast, confirmModal, id, ids, INDEX_META, pad2
  };
})();
